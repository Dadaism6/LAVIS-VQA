...
from vlm_encoder_extractor import CustomVLMEncoderFeatureExtractor
...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp-name", default="vlm _encoder_rl_initial_test", type=str, help="The experiment name.")
    parser.add_argument("--wandb", action="store_true", help="Set to True to upload stats to wandb.")
    parser.add_argument("--seed", default=0, type=int, help="The random seed.")
    parser.add_argument("--device", default="cuda:2", type=str, help="The CUDA Device")
    parser.add_argument("--feature-dim", default=8192, type=int, help="The feature dim used for RL")
    ...
    config = dict(
        ...
        algo=dict(
            ...
            policy_kwargs=dict(net_arch=[128],
                               features_extractor_class=CustomVLMEncoderFeatureExtractor,
                               features_extractor_kwargs=dict(device = device, features_dim=feature_dim),
                               ),
            env=None,
